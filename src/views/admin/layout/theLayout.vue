...
<script>
    import TheLayoutHeader from './layoutHeader'
    import TheLayoutSidebar from './layoutSidebar'
    import TheLayoutFooter from './layoutFooter'
    import TheLayoutMain from './layoutMain'
    export default {
        name: 'theLayout',
        data () {
            return {
